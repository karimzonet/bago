...
export const addPost = async options => {
  let {
    ...
    targetFile=localStorage.getItem('bookingNumber'),
    ...
    bookingStatus=localStorage.getItem('bookingStatus'),
    terminal=localStorage.getItem('terminal'),
    aerogare=localStorage.getItem('aerogare'),
    allowance=localStorage.getItem('allowance'),
    kilo=localStorage.getItem('kilo'),
    prixUnit=localStorage.getItem('prixUnit'),
    prixTotal=localStorage.getItem('prixTotal'),
    iban=localStorage.getItem('iban'),
    accompanied=localStorage.getItem('accompanied'),
  ...
  form.append('bookingNumber', bookingNumber)
    form.append('numberTransaction', numberTransaction)
    form.append('departureDate', departureDate)
    form.append('arrivalDate', arrivalDate)
    form.append('firstName', firstName)
    form.append('lastName', lastName)
    form.append('departure', departure)
    form.append('arrival', arrival)
    form.append('company', company)
    form.append('bookingStatus', bookingStatus)
    form.append('terminal', terminal)
    form.append('aerogare', aerogare)
    form.append('allowance', allowance)
    form.append('kilo', kilo)
    form.append('prixUnit', prixUnit)
    form.append('prixTotal', prixTotal)
    form.append('iban', iban)
    form.append('accompanied', accompanied)
  let {

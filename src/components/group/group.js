  ...
  render() {
    ...
    return (
      <div>
        <Title
          value={name}
          desc={`Voir les annonces de ${name}, ses membres et plus encore..`}
        />
        ...
        <FadeIn duration="300ms" className={cLoading(loading)}>
          ...
          {showContent ? (
            ...
            <div style={{ marginTop: 85, marginBottom:92}}>
              <Nothing mssg={`Le groupe ${name} est privé. Rejoignez le pour vous connecter!!`} />
            </div>
          )}
        </FadeIn>
      </div>
